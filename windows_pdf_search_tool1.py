    ...
    for file in files:
        ...
        if lst != []:
            with open("compiled_pdf.txt", "a") as file:
                ...
                file.write('\n')
                file.write('\n')
            # rowLst.append(filename)
            # rowLst.append("These are the slide numbers that contain your search phrase: ")
            # rowLst.append(lst)
            #rowLst.append(\n)
        #rowLst.append([filename, lst])
    # with open("compiled_pdf.txt", "a", newline = "") as file:
    #     #writer = writer(filename)
    #     file.writelines(str(rowLst))
    popupmsg("Done!")
